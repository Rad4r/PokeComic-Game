...
public class ComicManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentPanelNumber < panels.Length - 1 && currentPanelNumber != 6 && Input.GetKeyDown(KeyCode.UpArrow)) //Input.GetButtonDown("Submit") Disable during the battle and choice panel
